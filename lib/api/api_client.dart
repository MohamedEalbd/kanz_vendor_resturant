...
import 'dart:io';
import 'package:hamy_yamy/api/api_checker.dart';
import 'package:file_picker/file_picker.dart';
import 'package:flutter/foundation.dart';
import 'package:http_parser/http_parser.dart';
import 'package:hamy_yamy/common/models/error_response.dart';
...
class ApiClient extends GetxService {
  ...
  // Future<Response> newPostData({String? uri, dynamic body, Map<String, String>? headers, bool handleError = true}) async {
  //   try {
  //     debugPrint('====> API Call: $uri\nHeader: $headers \nMain Header: $_mainHeaders');
  //     debugPrint('====> API Body: $body');
  //     http.Response response = await http.post(
  ...
  Future<Response> postMultipartData(String uri, Map<String, String> body, List<MultipartBody> multipartBody, List<MultipartDocument> otherFile, {Map<String, String>? headers, bool handleError = true}) async {
    try {
      log('====> API Call: $uri\nHeader: $_mainHeaders');
      log('====> API Body: $body with ${multipartBody.length} and multipart ${otherFile.length}');
