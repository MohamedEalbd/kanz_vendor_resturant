...
ThemeData dark = ThemeData(
  ...
  primaryColor: const Color(0xFF0fb3ad),
  ...
  colorScheme: const ColorScheme.dark(primary: Color(0xFF0fb3ad), secondary: Color(0xFF0fb3ad)).copyWith(error: const Color(0xFFdd3135), tertiary: const Color(0xFF334257)),
