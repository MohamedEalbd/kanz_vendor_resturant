...
class AppConstants {
  static const String appName = 'كنز -المطعم';
  static const double appVersion = 1.0; ///Flutter SDK 3.27.1

  static const String baseUrl = 'https://kanz.nixtzone.com';
  ...
  static String restaurantUpdateUri(id) {
    return '/api/v1/restaurants/update/$id';
  }
