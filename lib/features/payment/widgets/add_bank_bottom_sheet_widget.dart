...
import 'package:hamy_yamy/features/payment/widgets/bank_field_widget.dart';
        ...
        GetBuilder<PaymentController>(builder: (paymentController) {
          return !paymentController.isLoading ? CustomButtonWidget(
            ...
            onPressed: () {
              ...
              if(widget.bankName == bankName && widget.branchName == branchName && widget.holderName == holderName
                  && widget.accountNo == accountNo) {
