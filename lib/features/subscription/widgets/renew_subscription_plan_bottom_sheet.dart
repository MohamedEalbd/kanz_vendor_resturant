...
import 'package:hamy_yamy/features/business/widgets/curve_clipper_widget.dart';
...
import 'package:hamy_yamy/features/subscription/domain/models/check_product_limit_model.dart';
        ...
        child: Column(children: [
          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      child: Stack(children: [
                        ...
                        Positioned(
                          ...
                          child: Column(children: [
                            ...
                            Text(
                              businessIsCommission ? '${Get.find<SplashController>().configModel!.adminCommission}%' : PriceConverter.convertPrice(activePackage?.price ?? 0),
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        Text(PriceConverter.convertPrice(price), style: robotoBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                      ]),
                    ),
                ...
                (checkProductLimitModel != null && checkProductLimitModel!.backAmount != null && checkProductLimitModel!.backAmount! > 0) ? Padding(
                  padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                  child: Text(
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child:  Row(children: [
                      ...
                      Text(
                        PriceConverter.convertPrice(subscriptionController.profileModel!.balance),
                        style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault),
                      ),
          ...
          Container(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Expanded(
                flex: 2,
                child: !subscriptionController.renewLoading ? CustomButtonWidget(
                  onPressed: () {
                    if(!subscriptionController.isSelect && !subscriptionController.isDigitalPaymentSelect){
                      ...
                      subscriptionController.renewBusinessPlan(restaurantId: subscriptionController.profileModel!.restaurants![0].id.toString(), isCommission: package.id == -1);
                    }
                  },
                  buttonText: isRenew && (nonSubscription == false) ? 'renew_subscription_plan'.tr : (isRenew && nonSubscription) ? 'submit'.tr : 'shift_subscription_plan'.tr,
                  radius: Dimensions.radiusDefault,
