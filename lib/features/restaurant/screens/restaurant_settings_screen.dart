...
import 'package:hamy_yamy/common/widgets/custom_dropdown_widget.dart';
import 'package:hamy_yamy/common/widgets/custom_image_widget.dart';
import 'package:hamy_yamy/common/widgets/custom_ink_well_widget.dart';
import 'package:hamy_yamy/common/widgets/custom_snackbar_widget.dart';
import 'package:hamy_yamy/common/widgets/custom_text_field_widget.dart';
import 'package:hamy_yamy/common/widgets/custom_text_form_field_widget.dart';
import 'package:hamy_yamy/common/widgets/switch_button_widget.dart';
...
import 'package:hamy_yamy/common/models/config_model.dart';
...
import 'package:hamy_yamy/features/restaurant/widgets/daily_time_widget.dart';
import 'package:hamy_yamy/helper/type_converter.dart';
    ...
    return Scaffold(
      ...
      body: GetBuilder<RestaurantController>(builder: (restController) {
        ...
        return Column(children: [
          ...
          Expanded(child: SingleChildScrollView(
            ...
            child: Column(children: [
             ...
             // const SizedBox(height: Dimensions.paddingSizeLarge),
              ...
              Get.find<SplashController>().configModel!.toggleVegNonVeg! ? Column(children: [

                Align(alignment: Alignment.centerLeft, child: Text('food_type'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge))),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
              ...
              Get.find<SplashController>().configModel!.extraPackagingChargeStatus! ? Column(children: [

                Row(children: [

                  Expanded(
                    child: Text('extra_package_charge'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),),
                  ),
                ...
                Align(
                  ...
                  child: Text('leave_the_input_box_empty_to_not_offering_extra_packaging_charge'.tr, style: robotoRegular.copyWith(color: Theme.of(context).disabledColor)),
                ),
                const SizedBox(height: Dimensions.paddingSizeSmall),
              ...
              //   ]),
              // ) : const SizedBox(),
             // SizedBox(height: Get.find<SplashController>().configModel!.instantOrder! ? Dimensions.paddingSizeDefault : 0),

              // Align(
              //   alignment: Alignment.topLeft,
              //   child: Text('restaurant_cover'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              // ),
              // const SizedBox(height: Dimensions.paddingSizeExtraSmall),
          ...
          SafeArea(
            child: !restController.isLoading ? Container(
              padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: Dimensions.paddingSizeSmall),
              decoration: BoxDecoration(
                color: Theme.of(context).cardColor,
                boxShadow: [BoxShadow(color: Get.isDarkMode ? Colors.black.withOpacity( 0.2) : Colors.grey.withOpacity( 0.3), spreadRadius: 1, blurRadius: 10, offset: const Offset(0, 1))],
              ),
