...
import 'package:hamy_yamy/common/widgets/custom_time_picker_widget.dart';
import 'package:hamy_yamy/common/widgets/custom_tool_tip_widget.dart';
...
import 'package:hamy_yamy/features/restaurant/widgets/stock_section_widget.dart';
import 'package:hamy_yamy/features/splash/controllers/splash_controller.dart';
import 'package:hamy_yamy/features/restaurant/domain/models/variation_model.dart';
...
import 'package:hamy_yamy/features/restaurant/widgets/variation_view_widget.dart';
import 'package:hamy_yamy/helper/custom_print_helper.dart';
...
class _AddProductScreenState extends State<AddProductScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    Get.find<CategoryController>().setCategoryIndex(0,false);
            ...
            Column(children: [
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Container(
                        ...
                        child: DropdownButton<int>(
                          ...
                          onChanged: (int? value) {
                            log("value $value");
                            log("initialized ${categoryController.categoryIndex}");
              ...
              !restController.isLoading ? CustomButtonWidget(
                ...
                onPressed: () {
                  ...
                  }else if(restController.tagList.isEmpty) {
                    showCustomSnackBar('pleaseAddATag'.tr);
                  }else {
