...
import 'package:hamy_yamy/features/restaurant/domain/enum/time_type.dart';
...
import 'package:hamy_yamy/features/restaurant/domain/models/variant_type_model.dart';
...
class RestaurantController extends GetxController implements GetxService {
  ...
  void initRestaurantData(Restaurant restaurant) {
    ...
    _restaurantTagList = [];
    _restaurantTagList.addAll(restaurant.tags!=null? restaurant.tags!:[]);
  }
