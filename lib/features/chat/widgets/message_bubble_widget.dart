...
import 'package:hamy_yamy/features/chat/widgets/chat_video_view.dart';
import 'package:hamy_yamy/features/chat/widgets/image_file_view_widget.dart';
import 'package:hamy_yamy/features/chat/widgets/pdf_view_widget.dart';
...
import 'package:hamy_yamy/features/chat/domain/models/message_model.dart';
import 'package:hamy_yamy/helper/user_type.dart';
import 'package:hamy_yamy/util/color_resources.dart';
...
class MessageBubbleWidget extends StatelessWidget {
  ...
  const MessageBubbleWidget({super.key, required this.currentMessage, required this.user, required this.userType, required this.previousMessage,
                  ...
                  currentMessage.filesFullUrl!.isNotEmpty ? Directionality(
                    ...
                    child: SizedBox(
                      ...
                      child: _isVideo(currentMessage.filesFullUrl![0]) ? InkWell(
                          ...
                          child: ChatVideoView(url: currentMessage.filesFullUrl![0])) : _isPdf(currentMessage.filesFullUrl![0])
