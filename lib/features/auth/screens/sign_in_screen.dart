...
import 'package:hamy_yamy/features/auth/widgets/restaurant_registartion_success_bottom_sheet.dart';
        ...
        if (status != null) {
          if (status.isSuccess) {
            ...
            SecureStorageService.instance
                .setValue(key: ApiKeys.email, value: email);
            SecureStorageService.instance.setValue(
                key: ApiKeys.password, value: password);
