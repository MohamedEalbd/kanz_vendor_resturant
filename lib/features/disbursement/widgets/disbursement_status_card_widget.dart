...
class DisbursementStatusCardWidget extends StatelessWidget {
  ...
  const DisbursementStatusCardWidget({super.key, required this.amount, this.isPending = false, this.isCompleted = false, this.isCanceled = false,
    required this.text});
        ...
        Expanded(
          child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Text(text, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),
