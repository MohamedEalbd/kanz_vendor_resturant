import 'dart:convert';
import 'package:hamy_yamy/common/controllers/theme_controller.dart';
import 'package:hamy_yamy/api/api_client.dart';
import 'package:hamy_yamy/features/addon/controllers/addon_controller.dart';
import 'package:hamy_yamy/features/addon/domain/repositories/addon_repository.dart';
import 'package:hamy_yamy/features/addon/domain/repositories/addon_repository_interface.dart';
import 'package:hamy_yamy/features/addon/domain/services/addon_service.dart';
import 'package:hamy_yamy/features/addon/domain/services/addon_service_interface.dart';
import 'package:hamy_yamy/features/advertisement/controllers/advertisement_controller.dart';
import 'package:hamy_yamy/features/advertisement/domain/repositories/advertisement_repository.dart';
import 'package:hamy_yamy/features/advertisement/domain/repositories/advertisement_repository_interface.dart';
import 'package:hamy_yamy/features/advertisement/domain/services/advertisement_service.dart';
import 'package:hamy_yamy/features/advertisement/domain/services/advertisement_service_interface.dart';
import 'package:hamy_yamy/features/auth/controllers/auth_controller.dart';
import 'package:hamy_yamy/features/auth/controllers/forgot_password_controller.dart';
import 'package:hamy_yamy/features/auth/controllers/location_controller.dart';
import 'package:hamy_yamy/features/auth/domain/repositories/auth_repository.dart';
import 'package:hamy_yamy/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:hamy_yamy/features/auth/domain/repositories/forgot_password_repository.dart';
import 'package:hamy_yamy/features/auth/domain/repositories/forgot_password_repository_interface.dart';
import 'package:hamy_yamy/features/auth/domain/repositories/location_repository.dart';
import 'package:hamy_yamy/features/auth/domain/repositories/location_repository_interface.dart';
import 'package:hamy_yamy/features/auth/domain/services/auth_service.dart';
import 'package:hamy_yamy/features/auth/domain/services/auth_service_interface.dart';
import 'package:hamy_yamy/features/auth/domain/services/forgot_password_service.dart';
import 'package:hamy_yamy/features/auth/domain/services/forgot_password_service_interface.dart';
import 'package:hamy_yamy/features/auth/domain/services/location_service.dart';
import 'package:hamy_yamy/features/auth/domain/services/location_service_interface.dart';
import 'package:hamy_yamy/features/business/controllers/business_controller.dart';
import 'package:hamy_yamy/features/business/domain/repositories/business_repository.dart';
import 'package:hamy_yamy/features/business/domain/repositories/business_repository_interface.dart';
import 'package:hamy_yamy/features/business/domain/services/business_service.dart';
import 'package:hamy_yamy/features/business/domain/services/business_service_interface.dart';
import 'package:hamy_yamy/features/campaign/controllers/campaign_controller.dart';
import 'package:hamy_yamy/features/campaign/domain/repositories/campaign_repository.dart';
import 'package:hamy_yamy/features/campaign/domain/repositories/campaign_repository_interface.dart';
import 'package:hamy_yamy/features/campaign/domain/services/campaign_service.dart';
import 'package:hamy_yamy/features/campaign/domain/services/campaign_service_interface.dart';
import 'package:hamy_yamy/features/category/controllers/category_controller.dart';
import 'package:hamy_yamy/features/category/domain/repositories/category_repository.dart';
import 'package:hamy_yamy/features/category/domain/repositories/category_repository_interface.dart';
import 'package:hamy_yamy/features/category/domain/services/category_service.dart';
import 'package:hamy_yamy/features/category/domain/services/categoty_service_interface.dart';
import 'package:hamy_yamy/features/chat/controllers/chat_controller.dart';
import 'package:hamy_yamy/features/chat/domain/repositories/chat_repository.dart';
import 'package:hamy_yamy/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:hamy_yamy/features/chat/domain/services/chat_service.dart';
import 'package:hamy_yamy/features/chat/domain/services/chat_service_interface.dart';
import 'package:hamy_yamy/features/coupon/controllers/coupon_controller.dart';
import 'package:hamy_yamy/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:hamy_yamy/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:hamy_yamy/features/coupon/domain/services/coupon_service.dart';
import 'package:hamy_yamy/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:hamy_yamy/features/deliveryman/controllers/deliveryman_controller.dart';
import 'package:hamy_yamy/features/deliveryman/domain/repositories/deliveryman_repository.dart';
import 'package:hamy_yamy/features/deliveryman/domain/repositories/deliveryman_repository_interface.dart';
import 'package:hamy_yamy/features/deliveryman/domain/services/deliveryman_service.dart';
import 'package:hamy_yamy/features/deliveryman/domain/services/deliveryman_service_interface.dart';
import 'package:hamy_yamy/features/disbursement/controllers/disbursement_controller.dart';
import 'package:hamy_yamy/features/disbursement/domain/repositories/disbursement_repository.dart';
import 'package:hamy_yamy/features/disbursement/domain/repositories/disbursement_repository_interface.dart';
import 'package:hamy_yamy/features/disbursement/domain/services/disbursement_service.dart';
import 'package:hamy_yamy/features/disbursement/domain/services/disbursement_service_interface.dart';
import 'package:hamy_yamy/features/expense/controllers/expense_controller.dart';
import 'package:hamy_yamy/features/expense/domain/repositories/expense_repository.dart';
import 'package:hamy_yamy/features/expense/domain/repositories/expense_repository_interface.dart';
import 'package:hamy_yamy/features/expense/domain/services/expense_service.dart';
import 'package:hamy_yamy/features/expense/domain/services/expense_service_interface.dart';
import 'package:hamy_yamy/features/language/controllers/localization_controller.dart';
import 'package:hamy_yamy/features/language/domain/repositories/language_repository.dart';
import 'package:hamy_yamy/features/language/domain/repositories/language_repository_interface.dart';
import 'package:hamy_yamy/features/language/domain/services/language_service.dart';
import 'package:hamy_yamy/features/language/domain/services/language_service_interface.dart';
import 'package:hamy_yamy/features/notification/controllers/notification_controller.dart';
import 'package:hamy_yamy/features/notification/domain/repositories/notification_repository.dart';
import 'package:hamy_yamy/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:hamy_yamy/features/notification/domain/services/notification_service.dart';
import 'package:hamy_yamy/features/notification/domain/services/notification_service_interface.dart';
import 'package:hamy_yamy/features/order/controllers/order_controller.dart';
import 'package:hamy_yamy/features/order/domain/repositories/order_repository.dart';
import 'package:hamy_yamy/features/order/domain/repositories/order_repository_interface.dart';
import 'package:hamy_yamy/features/order/domain/services/order_service.dart';
import 'package:hamy_yamy/features/order/domain/services/order_service_interface.dart';
import 'package:hamy_yamy/features/payment/controllers/payment_controller.dart';
import 'package:hamy_yamy/features/payment/domain/repositories/payment_repository.dart';
import 'package:hamy_yamy/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:hamy_yamy/features/payment/domain/services/payment_service.dart';
import 'package:hamy_yamy/features/payment/domain/services/payment_service_interface.dart';
import 'package:hamy_yamy/features/pos/controllers/pos_controller.dart';
import 'package:hamy_yamy/features/pos/domain/repositories/pos_repository.dart';
import 'package:hamy_yamy/features/pos/domain/repositories/pos_repository_interface.dart';
import 'package:hamy_yamy/features/pos/domain/services/pos_service.dart';
import 'package:hamy_yamy/features/pos/domain/services/pos_service_interface.dart';
import 'package:hamy_yamy/features/profile/controllers/profile_controller.dart';
import 'package:hamy_yamy/features/profile/domain/repositories/profile_repository.dart';
import 'package:hamy_yamy/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:hamy_yamy/features/profile/domain/services/profile_service.dart';
import 'package:hamy_yamy/features/profile/domain/services/profile_service_interface.dart';
import 'package:hamy_yamy/features/reports/controllers/report_controller.dart';
import 'package:hamy_yamy/features/reports/domain/repositories/report_repository.dart';
import 'package:hamy_yamy/features/reports/domain/repositories/report_repository_interface.dart';
import 'package:hamy_yamy/features/reports/domain/services/report_service.dart';
import 'package:hamy_yamy/features/reports/domain/services/report_service_interface.dart';
import 'package:hamy_yamy/features/restaurant/controllers/restaurant_controller.dart';
import 'package:hamy_yamy/features/restaurant/domain/repositories/restaurant_repository.dart';
import 'package:hamy_yamy/features/restaurant/domain/repositories/restaurant_repository_interface.dart';
import 'package:hamy_yamy/features/restaurant/domain/services/restaurant_service.dart';
import 'package:hamy_yamy/features/restaurant/domain/services/restaurant_service_interface.dart';
import 'package:hamy_yamy/features/splash/controllers/splash_controller.dart';
import 'package:hamy_yamy/features/splash/domain/repositories/splash_repository.dart';
import 'package:hamy_yamy/features/splash/domain/repositories/splash_repository_service.dart';
import 'package:hamy_yamy/features/splash/domain/services/splash_service.dart';
import 'package:hamy_yamy/features/splash/domain/services/splash_service_interface.dart';
import 'package:hamy_yamy/features/subscription/controllers/subscription_controller.dart';
import 'package:hamy_yamy/features/subscription/domain/repositories/subscription_repository.dart';
import 'package:hamy_yamy/features/subscription/domain/repositories/subscription_repository_interface.dart';
import 'package:hamy_yamy/features/subscription/domain/services/subscription_service.dart';
import 'package:hamy_yamy/features/subscription/domain/services/subscription_service_interface.dart';
import 'package:hamy_yamy/util/app_constants.dart';
import 'package:hamy_yamy/features/language/domain/models/language_model.dart';
